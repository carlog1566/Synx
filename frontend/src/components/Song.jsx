...
const Song = ({ song, analyzingIds, handleAnalyze, formatDuration }) => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-200">
            ...
            <Link 
                to={`${song.id}`} 
                className={isAnalyzing ? 'pointer-events-none' : ''}
            >
            ...
            <div className="p-6 space-y-4">
                ...
                {/* Analyzing Status */}
                {isAnalyzing && (
                    <div className="flex items-center text-primary bg-purple-100 px-3 py-2 rounded-lg">
                ...
                <div className="space-y-2">
                    ...
                    {song.analysis_failed && (
                        ...
                        >
                            ...
                            {isAnalyzing ? 'Analyzing...' : 'Analysis Failed - Retry'}
                        </button>
                    )}

                    {/* Analyze Button */}
                    {song.audio_file && !song.analyzed && !song.analysis_failed && !isAnalyzing && (
                        <button 
                            onClick={() => handleAnalyze(song.id)}
