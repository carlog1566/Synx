...
function App() {
	...
	const paddingClass =  ((isRegister || isLogin || forgotPassword || resetPassword) && menuOpen) ? 'pt-72 py-8' : menuOpen ? 'pt-88 py-8' : (isRegister || isLogin || forgotPassword || resetPassword) ? 'pt-0 py-0' : 'pt-16 md:py-36'
